...
class Restaurants(models.Model):
    ...
    crypto_payment_option = models.BooleanField(default=False, verbose_name='Is cryptocurrency payment option available?')
    ...
    url_google_map = models.URLField(null=True, blank=True, verbose_name='Google Maps location URL')
